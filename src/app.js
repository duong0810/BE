...
app.use(cors({
  ...
  allowedHeaders: ['Content-Type', 'Authorization', 'x-requested-with', 'zalo-access-token', 'access-token']
}));
...
app.options('*', (req, res) => {
  ...
  res.header('Access-Control-Allow-Headers', 'Content-Type, Authorization, x-requested-with, zalo-access-token, access-token');
